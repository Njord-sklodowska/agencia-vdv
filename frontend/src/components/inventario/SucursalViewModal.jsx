...
const SucursalViewModal = ({ isOpen, onClose, data }) => {
      ...
      <div className="modal-dialog modal-md modal-dialog-centered">
        <div className="modal-content border-0 shadow">
          <div className="modal-header modal-view-header">
            <h5 className="modal-title fw-bold">Detalles de la Sucursal</h5>
          ...
          <div className="modal-body modal-view-body">
            ...
            <div className="list-group list-group-flush">
              <div className="list-group-item d-flex justify-content-between align-items-center px-0">
                <span className="text-muted small">Ciudad / Provincia</span>
                <span className="fw-medium">{`${data.ciudad}, ${data.provincia}`}</span>
              </div>
              <div className="list-group-item d-flex justify-content-between align-items-center px-0">
...
export default SucursalViewModal;
