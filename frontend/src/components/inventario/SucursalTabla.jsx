...
const SucursalTabla = ({ sucursales, totalCount, pagination, sorting = { id: 'nombre', desc: false }, setPage, setPageSize, toggleSort, filters, onView, onEdit, onDelete }) => {
    ...
    },
    {
      ...
      cell: info => (
        <div className="d-flex gap-2">
          <button className="btn btn-sm btn-outline-info" onClick={() => onView(info.row.original)} title="Ver Detalles">
            <i className="bi bi-eye"></i>
          </button>
          <button className="btn btn-sm btn-outline-primary" onClick={() => onEdit(info.row.original)} title="Editar">
            <i className="bi bi-pencil"></i>
          </button>
          <button className="btn btn-sm btn-outline-danger" onClick={() => onDelete(info.row.original)} title="Eliminar">
