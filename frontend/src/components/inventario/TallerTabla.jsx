...
const TallerTabla = ({ talleres, totalCount, pagination, sorting = { id: 'nombre', desc: false }, setPage, setPageSize, toggleSort, filters, onView, onEdit, onDelete }) => {
